<div class="list-group card dashCard mb-4">
    ...
    <a href="{{ '/'.auth()->user()->roles->first()->name .'/projects' }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"><i class="fas fa-project-diagram"></i> Projects <span class="badge badge-success badge-pill">{{\App\Project::count()}}</span></a>
</div>
